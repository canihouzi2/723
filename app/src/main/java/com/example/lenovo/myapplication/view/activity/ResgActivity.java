...
public class ResgActivity extends BeasActivity<LogiPresent> implements ICountView.IloginView {
    ...
    public void Success(LogBean logBean) {
       if (logBean!=null){
           ...
           if ("0000".equals(logBean.getStatus())){
               Intent intent=new Intent(ResgActivity.this,LogiActivity.class);
